...
import { generateFOTP, verifyOTP } from '../helper/helper';
import { useNavigate } from 'react-router-dom'

export default function Fotp() {
  ...
  useEffect(() => {
    generateFOTP(username).then((OTP) => {
      console.log(OTP)
  ...
  function resendOTP(){
    ...
    let sentPromise = generateFOTP(username);
      ...
      <div className='flex justify-center items-center h-screen'>
        <div className={styles.glass}>
          ...
          <div className="title flex flex-col items-center">
            <h4 className='text-5xl font-bold'>Two Factor Authentication</h4>
